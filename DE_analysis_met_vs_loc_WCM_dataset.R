#
###########################################################################################
##### Discovery analysis [localized vs metastatic] (WCM PNET dataset)
###########################################################################################
...
write.csv(counts, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/WCM_dataset_counts.csv')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_SV_plots.pdf')
...
design(dds) = ~ SV_1 + SV_2 + SV_3 + SV_4 + SV_5 + SV_6 + Loc_or_Met
...
# 1 rows did not converge in beta
...
summary(rr)
# out of 32815 with nonzero total read count
# adjusted p-value < 0.1
# LFC > 0 (up)       : 375, 1.1%
# LFC < 0 (down)     : 568, 1.7%
# outliers [1]       : 0, 0%
# low counts [2]     : 10816, 33%
# (mean count < 3)
# [1] see 'cooksCutoff' argument of ?results
# [2] see 'independentFiltering' argument of ?results

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_Cooks_distances.pdf')
...
# save releveant data
save(se, gse, tpm, ddsClean, rr, vsd, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Met_vs_Loc_WCM_dataset_DESeq2_DEbyMetStatus_BUNDLE.rda')
# load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Met_vs_Loc_WCM_dataset_DESeq2_DEbyMetStatus_BUNDLE.rda') # se, gse, tpm, ddsClean, rr, vsd

################ Downstream analysis

source('/athena/masonlab/scratch/users/nai2008/ivanov_functions.R')
library(DESeq2)
load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Met_vs_Loc_WCM_dataset_DESeq2_DEbyMetStatus_BUNDLE.rda') # se, gse, tpm, dds, ddsClean, rr, vsd, rld
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_M1_and_M2_heatmaps.pdf')
...
length(which(out$TF==TRUE)) # 115

save(out, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Met_vs_Loc_WCM_dataset_DE_genes_byMetStatus.rda')
...
write.csv(out,file="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/Met_vs_Loc_WCM_dataset_DE_genes_byMetStatus.csv", row.names=FALSE)

### calculate concordance scores with the mouse transcriptome for M1 and M2 genes

load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/M1_and_M2_gene_sets.rda') #M1_marker_panel,M2_marker_panel,genes_upregulated_in_M1_and_downregulated_in_M2,genes_upregulated_in_M2_and_downregulated_in_M1

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_M1_and_M2_concordance_scores.pdf')
...
length(which(disco.score>0))/length(disco.score) # 0.7
...
length(which(disco.score>0))/length(disco.score) # 0.59375
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_goseq_pwf_plot.pdf')
plotPWF(pwf)
dev.off()
...
# GO:0010273            1.827957e-07                        1          7
# numInCat                         term ontology over_represented_FDR
# 12 detoxification of copper ion       BP          0.003408592

write.csv(GO.KEGG.wall_sig, file = '/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/Met_vs_Loc_WCM_dataset_DEbyMetStatus_ORA.csv')
...
save(genes_of_interest_rr_subset, file = '/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Met_vs_Loc_WCM_dataset_genes_of_interest_rr_subset.rda')
# load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Met_vs_Loc_WCM_dataset_genes_of_interest_rr_subset.rda') # genes_of_interest_rr_subset
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_genes_of_interest_TPMs.pdf')
...
genes_to_plot=data.frame(ensembl=genes_jacques$Ensembl, info='Discovery dataset')

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_genes_of_interest_TPMs_forJacques.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_volcano_plot_DEbyMetStatus.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_inSilico_deconvolution.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_deconvolution_cellType_comparisons_quantiseq.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_deconvolution_cellType_comparisons_epic.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_deconvolution_cellType_comparisons_cibersort.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_deconvolution_cellType_comparisons_mcpCounter.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Met_vs_Loc_WCM_dataset_deconvolution_cellType_comparisons_xCell.pdf')
...
write.csv(log_tpm_plus1, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/WCM_dataset_log_tpm_plus1.csv')
