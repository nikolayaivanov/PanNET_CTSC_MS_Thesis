#
###########################################################################################
##### Discovery analysis [case vs control] (WCM PNET dataset vs. Fadista control pancreatic islets)
###########################################################################################
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_SV_plots.pdf')
...
design(dds) = ~ SV_1 + SV_2 + SV_3 + SV_4 + SV_5 + SV_6 + SV_7 + SV_8 + SV_9 + SV_10 + SV_11 + SV_12 + SV_13 + SV_14 + SV_15 + SV_16 + SV_17 + SV_18 + SV_19 + SV_20 + SV_21 + SV_22 + SV_23 + Dx
...
# 617 rows did not converge in beta
...
summary(rr)
# out of 33185 with nonzero total read count
# adjusted p-value < 0.1
# LFC > 0 (up)       : 10088, 30%
# LFC < 0 (down)     : 7753, 23%
# outliers [1]       : 0, 0%
# low counts [2]     : 4504, 14%
# (mean count < 0)
# [1] see 'cooksCutoff' argument of ?results
# [2] see 'independentFiltering' argument of ?results

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_Cooks_distances.pdf')
...
# make transformed count data, using regularized log transformation
rld = rlog(ddsClean, blind=FALSE)

# save releveant data
save(se, gse, tpm, ddsClean, rr, vsd, rld, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/WCM_and_Fadista_datasets_DESeq2_DEbyDx_BUNDLE.rda')
...
rlt_counts = assay(rld)
all(rownames(vst_counts)==rownames(rlt_counts)) #TRUE

mm=match(rownames(vst_counts),genes$gene_id)
which(is.na(mm)) # none
rownames(vst_counts) = genes$gene_name[mm]
rownames(rlt_counts) = genes$gene_name[mm]
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_M1_and_M2_heatmaps.pdf')
...
pheatmap(rlt_counts[mm_M1,], color=colorRampPalette(rev(brewer.pal(n = 11, name = "RdBu")))(3000), main='M1 marker panel (RLT transformed counts)', 
	cluster_rows=TRUE, cluster_cols=TRUE, annotation_col=annotation_col, scale='row', fontsize_col=3)
...
pheatmap(rlt_counts[mm_M2,], color=colorRampPalette(rev(brewer.pal(n = 11, name = "RdBu")))(3000), main='M2 marker panel (RLT transformed counts)', 
	cluster_rows=TRUE, cluster_cols=TRUE, annotation_col=annotation_col, scale='row', fontsize_col=3)
...
length(which(out$TF==TRUE)) # 2097

save(out, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/WCM_and_Fadista_datasets_DE_genes_byDx.rda')
...
write.csv(out,file="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/WCM_and_Fadista_datasets_DE_genes_byDx.csv", row.names=FALSE)

### calculate concordance scores with the mouse transcriptome for M1 and M2 genes

load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/M1_and_M2_gene_sets.rda') #M1_marker_panel,M2_marker_panel,genes_upregulated_in_M1_and_downregulated_in_M2,genes_upregulated_in_M2_and_downregulated_in_M1

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_M1_and_M2_concordance_scores.pdf')
...
length(which(disco.score>0))/length(disco.score) # 0.5609756
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_goseq_pwf_plot.pdf')
plotPWF(pwf)
dev.off()
...
length(which(GO.KEGG.wall$over_represented_FDR<=0.1)) #96
...
write.csv(GO.KEGG.wall_sig, file = '/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/WCM_and_Fadista_datasets_DEbyDx_ORA.csv')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_ORA_plot.pdf')
par(mar=c(5.1, 12, 4.1, 0))
...
save(genes_of_interest_rr_subset, file = '/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/WCM_and_Fadista_datasets_genes_of_interest_rr_subset.rda')
# load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/WCM_and_Fadista_datasets_genes_of_interest_rr_subset.rda') # genes_of_interest_rr_subset
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_genes_of_interest_TPMs.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_volcano_plot_DEbyDx.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_inSilico_deconvolution.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_deconvolution_cellType_comparisons_quantiseq.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_deconvolution_cellType_comparisons_epic.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_deconvolution_cellType_comparisons_cibersort.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_deconvolution_cellType_comparisons_mcpCounter.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/WCM_and_Fadista_datasets_deconvolution_cellType_comparisons_xCell.pdf')
