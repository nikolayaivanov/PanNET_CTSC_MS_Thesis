#
###########################################################################################
##### Validation analysis [male vs female] (Chan PNET dataset)
###########################################################################################
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_SV_plots.pdf')
...
design(dds) = ~ SV_1 + SV_2 + SV_3 + SV_4 + Sex
...
# LFC < 0 (down)     : 140, 0.44%
# outliers [1]       : 0, 0%
# low counts [2]     : 2460, 7.7%
# (mean count < 0)
# [1] see 'cooksCutoff' argument of ?results
# [2] see 'independentFiltering' argument of ?results

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_Cooks_distances.pdf')
...
# save releveant data
save(se, gse, tpm, ddsClean, rr, vsd, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Male_vs_Female_Chan_dataset_DESeq2_DEbySex_BUNDLE.rda')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_M1_and_M2_heatmaps.pdf')
...
length(which(out$TF==TRUE)) #20

save(out, file='/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Male_vs_Female_Chan_dataset_DE_genes_bySex.rda')
...
write.csv(out,file="/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/Male_vs_Female_Chan_dataset_DE_genes_bySex.csv", row.names=FALSE)

### calculate concordance scores with the mouse transcriptome for M1 and M2 genes

load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/M1_and_M2_gene_sets.rda') #M1_marker_panel,M2_marker_panel,genes_upregulated_in_M1_and_downregulated_in_M2,genes_upregulated_in_M2_and_downregulated_in_M1

pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_M1_and_M2_concordance_scores.pdf')
...
length(which(disco.score>0))/length(disco.score) # 0.7317073
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_goseq_pwf_plot.pdf')
plotPWF(pwf)
dev.off()
...
length(which(GO.KEGG.wall$over_represented_FDR<=0.1)) # 5
GO.KEGG.wall_sig = GO.KEGG.wall[which(GO.KEGG.wall$over_represented_FDR<=0.1),]

write.csv(GO.KEGG.wall_sig, file = '/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/data_tables/Male_vs_Female_Chan_dataset_DEbySex_ORA.csv')
...
save(genes_of_interest_rr_subset, file = '/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Male_vs_Female_Chan_dataset_genes_of_interest_rr_subset.rda')
# load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Male_vs_Female_Chan_dataset_genes_of_interest_rr_subset.rda') # genes_of_interest_rr_subset
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_genes_of_interest_TPMs.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_volcano_plot_DEbySex.pdf')
...
load('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/rdas/Male_vs_Female_Chan_dataset_DESeq2_DEbySex_BUNDLE.rda') # se, gse, tpm, ddsClean, rr, vsd
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_inSilico_deconvolution.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_deconvolution_cellType_comparisons_quantiseq.pdf')
...
colnames(abundance_matrix) = as.vector(ddsClean$Sex[mm])
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_deconvolution_cellType_comparisons_epic.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_deconvolution_cellType_comparisons_cibersort.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_deconvolution_cellType_comparisons_mcpCounter.pdf')
...
pdf('/athena/masonlab/scratch/users/nai2008/PNET_thesisProject/RNAseq_analysis/pdfs/Male_vs_Female_Chan_dataset_deconvolution_cellType_comparisons_xCell.pdf')
